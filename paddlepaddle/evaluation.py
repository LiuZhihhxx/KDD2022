...
class Loader(object):
    ...
    def load(path):
        ...
        try:
            ...
            sys.path.insert(0, os.path.join(*items[:-1]))
            # sys.path.append(os.path.join(*items[:-1]))
            ip_module = __import__(items[-1][:-3], fromlist=sys.path[-1])
            return ip_module
...
def evaluate(path_to_src_dir):
    ...
    # 2022/6/28 改为由./checkpoints/dirname的路径名字符串确定参数
    envs["data_path"] = DATA_DIR
    envs["filename"] = "wtdata_245days_knned.CSV"   # "wtbdata_245days.csv"
    envs["location_filename"] = "sdwpf_baidukddcup2022_turb_location.csv"
    envs["day_len"] = 144
    # envs["capacity"] = 6  # 2022/6/28 注释掉，capacity的定义在prepare中采用默认值
    envs["output_len"] = 288
    envs["out_var"] = 1
    ...
    if len(maes) == NUM_MAX_RUNS:
        ...
        print('\n{}\t{}\t{}'.format(avg_mae, avg_rmse,total_score))
...
# Must move the prepare.py out of the dir, otherwise a path conflict will happen (sys.path reason)
# For some unsettled reason about temporary path conflict, eval() can only launch once in a run.
if __name__ == "__main__":
    eval('paddle_wtdata_245days_knned.CSV_tMS_i72_o288_ls1_train200_val45_bs16_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i72_o288_ls1_train200_val45_bs16_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i72_o288_ls1_train200_val45_bs32_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i72_o288_ls1_train200_val45_bs32_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i72_o288_ls1_train200_val45_bs64_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i72_o288_ls1_train200_val45_bs64_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i72_o288_ls2_train200_val45_bs16_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i72_o288_ls2_train200_val45_bs16_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i72_o288_ls2_train200_val45_bs32_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i72_o288_ls2_train200_val45_bs32_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i72_o288_ls2_train200_val45_bs64_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i72_o288_ls2_train200_val45_bs64_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i72_o288_ls3_train200_val45_bs16_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i72_o288_ls3_train200_val45_bs16_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i72_o288_ls3_train200_val45_bs32_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i72_o288_ls3_train200_val45_bs32_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i72_o288_ls3_train200_val45_bs64_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i72_o288_ls3_train200_val45_bs64_lr0.0005.zip')

    # eval('paddle_wtdata_245days_knned.CSV_tMS_i144_o288_ls1_train200_val45_bs16_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i144_o288_ls1_train200_val45_bs16_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i144_o288_ls1_train200_val45_bs32_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i144_o288_ls1_train200_val45_bs32_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i144_o288_ls1_train200_val45_bs64_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i144_o288_ls1_train200_val45_bs64_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i144_o288_ls2_train200_val45_bs16_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i144_o288_ls2_train200_val45_bs16_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i144_o288_ls2_train200_val45_bs32_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i144_o288_ls2_train200_val45_bs32_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i144_o288_ls2_train200_val45_bs64_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i144_o288_ls2_train200_val45_bs64_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i144_o288_ls3_train200_val45_bs16_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i144_o288_ls3_train200_val45_bs16_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i144_o288_ls3_train200_val45_bs32_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i144_o288_ls3_train200_val45_bs32_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i144_o288_ls3_train200_val45_bs64_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i144_o288_ls3_train200_val45_bs64_lr0.0005.zip')
    #
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i288_o288_ls1_train200_val45_bs16_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i288_o288_ls1_train200_val45_bs16_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i288_o288_ls1_train200_val45_bs32_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i288_o288_ls1_train200_val45_bs32_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i288_o288_ls1_train200_val45_bs64_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i288_o288_ls1_train200_val45_bs64_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i288_o288_ls2_train200_val45_bs16_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i288_o288_ls2_train200_val45_bs16_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i288_o288_ls2_train200_val45_bs32_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i288_o288_ls2_train200_val45_bs32_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i288_o288_ls2_train200_val45_bs64_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i288_o288_ls2_train200_val45_bs64_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i288_o288_ls3_train200_val45_bs16_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i288_o288_ls3_train200_val45_bs16_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i288_o288_ls3_train200_val45_bs32_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i288_o288_ls3_train200_val45_bs32_lr0.0005.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i288_o288_ls3_train200_val45_bs64_lr0.0001.zip')
    # eval('paddle_wtdata_245days_knned.CSV_tMS_i288_o288_ls3_train200_val45_bs64_lr0.0005.zip')
