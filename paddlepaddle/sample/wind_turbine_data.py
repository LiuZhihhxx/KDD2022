...
class WindTurbineData(Dataset):
    ...
    scaler_collection = np.repeat(None, 134).tolist()
    ...
    def __init__(self, data_path,
        ...
        # WindTurbineData.scaler_collection = np.repeat(None, self.farm_capacity).tolist()

        # scaler_collection = None
        # if scaler_collection is None:
        #     scaler_collection = np.repeat(None, self.farm_capacity).tolist()
